...
@Component({
  selector: 'app-stock-tb-profile-detail-create',
  templateUrl: './stock-tb-profile-detail-create.component.html',
  styleUrls: ['./stock-tb-profile-detail-create.component.css']
})
export class StockTbProfileDetailCreateComponent implements OnInit {
  ...
  submit() {
    ...
    this.networkService.AddTbProfileDetail(this.mProduct).subscribe(
      data => {
