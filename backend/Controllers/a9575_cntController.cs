...
namespace backend.Controllers
{
    ...
    public class a9575_cntController : ControllerBase
    {

        ILogger<a9575_cntController> _logger;
        private readonly Ia9575CntRepository ia9575CntRepository;

        public a9575_cntController(ILogger<a9575_cntController> logger, Ia9575CntRepository ia9575CntRepository)
        {
            _logger = logger;
            this.ia9575CntRepository = ia9575CntRepository;
        ...
        public IActionResult Geta9575_cntAll()
        {
            ...
            try
            {
                var result = ia9575CntRepository.Geta9575_cntAll();
       ...
       [AllowAnonymous]
        ...
        public IActionResult Geta9575_cntById(int id)
        {
            try
            {
                var result = ia9575CntRepository.Geta9575_cntByID(id);
                if (result == null)
                {
        ...
        public IActionResult Adda9575_cnt([FromForm] a9575_cnt model)
        {
            try
            {
                var result = ia9575CntRepository.Adda9575_cnt(model);
                return Ok(new { result = result, message = "successfully" });
        ...
        public IActionResult Edita9575_cnt([FromForm] a9575_cnt model, int id)
        {
            try
            {
                ...
                result = ia9575CntRepository.Updatea9575_cnt(result);
                return Ok(new { result = result, message = "successfully" });
        ...
        public IActionResult Deletea9575_cnt(int id)
        {
            try
            {
                ...
                ia9575CntRepository.Deletea9575_cnt(result);
                return Ok(new { result = result, message = "successfully" });
            }
            catch (Exception ex)
            {
