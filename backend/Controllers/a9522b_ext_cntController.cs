...
namespace backend.Controllers
{
    ...
    public class a9522b_ext_cntController : ControllerBase
    {

        ILogger<a9522b_ext_cntController> _logger;
        private readonly Ia9522bExtCntRepository ia9522BExtCntRepository;

        public a9522b_ext_cntController(ILogger<a9522b_ext_cntController> logger, Ia9522bExtCntRepository ia9522BExtCntRepository)
        {
            _logger = logger;
            this.ia9522BExtCntRepository = ia9522BExtCntRepository;
          ...
          [HttpGet]
        public IActionResult Geta9522b_ext_cntAll()
        {
       ...
       [AllowAnonymous]
        ...
        [HttpPost]
        public IActionResult Adda9522b_ext_cnt([FromForm] a9522b_ext_cnt model)
        {
            try
            {
                var result = ia9522BExtCntRepository.Adda9522b_ext_cnt(model);
                return Ok(new { result = result, message = "successfully" });
